...
**If running on windows:** Make sure you have Rtools install before installing the isotopes package. You can download Rtools from [here](https://cran.r-project.org/bin/windows/Rtools/). **
